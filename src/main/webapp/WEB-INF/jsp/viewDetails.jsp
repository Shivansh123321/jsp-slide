...
body {
background-color: #00FFFF; /* For browsers that do not support gradients */
background-image: linear-gradient(-90deg, #FF69B4, #002D62);
background:#00FFFF;
}
@font-face
{
...
.slider div p{color:#ffffff;position:absolute;bottom:-65px; font-family:font; font-size:20px;}
.slider{
...
<body>
<div>
    <div class="slider" style="background-image: url("https://img1.goodfon.com/wallpaper/nbig/5/d1/tekstura-tekstury-cveta-linii.jpg")>
